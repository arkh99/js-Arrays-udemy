...
//   console.log(`The currency ${key} stands for ${value}`);
// })

// const currenciesun = new Set(["USD", "USD", "EUR", "GBP", "EUR", "EUR", "GBP"]);

// currenciesun.forEach(function (value, _, set) {
...
const checkDogs = function(dogjulia, dogskate) {
  ...
  juliacopy = juliacopy.splice(1, 2);
  const goodarr = [...juliacopy, ...dogskate];
  goodarr.forEach(function (age, index) {
    const type = age >= 3 ? "adult" : "puppy"
    console.log(`The Dog #${index + 1} is ${type} base on its age: ${age}`);
  })
}
...
// code challenge
/*go back to Julia and Kate's study about dogs. This time, they want to convert
